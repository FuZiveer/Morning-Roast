...
const CACHE = "morning-roast-v371"; // Keep in sync with APP_CACHE_VERSION in script.js
const ASSETS = [
  "./index.html",
  "./style.css",
  "./tools/games.js",
  ...
  "./tools/desktop-download.js",
  "./tools/desktop-update.js",
  "./script.js",
  "./assets/favicon.ico",
  "./assets/logo.png",
  "./assets/audio/soft-bell-ping.mp3",
  "./assets/audio/bright-ping.mp3",
  "./assets/audio/warm-chime.mp3",
